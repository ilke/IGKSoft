...
return [
    ...
    'name'   => 'Iyzico',
    'info'   => 'Pay securely using Iyzico.',
    'sort'   => 4,
    'fields' => [
        [
            'name'          => 'title',
            ...
            'name'          => 'api_key',
            'title'         => 'Iyzico API Key',
            'type'          => 'text',
            'channel_based' => false,
            'locale_based'  => false,
        ], [
            'name'          => 'secret_key',
            'title'         => 'Iyzico Secret Key',
            'type'          => 'text',
            'channel_based' => false,
            'locale_based'  => false,
        ], [
        ...
        'key'    => 'sales.payment_methods.ziraatpay',
        'name'   => 'Ziraat Bankası Kredi Kartı',
        'info'   => 'Ziraat Bankası ile güvenli ödeme',
        'sort'   => 5,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'name'          => 'api_key',
                'title'         => 'ZiraatPay API Key',
                'type'          => 'text',
                'channel_based' => false,
                'locale_based'  => false,
            ], [
                'name'          => 'merchant_id',
                'title'         => 'ZiraatPay Merchant ID',
                'type'          => 'text',
                'channel_based' => false,
                'locale_based'  => false,
            ], [
        ...
        'key'    => 'catalog.products.image_upload',
        'name'   => 'admin::app.configuration.index.catalog.products.image-upload.title',
        'info'   => 'admin::app.configuration.index.catalog.products.image-upload.info',
        'sort'   => 11,
        'fields' => [
            [
                'name'       => 'max_size',
                'title'      => 'admin::app.configuration.index.catalog.products.image-upload.max-size',
                'type'       => 'text',
                'validation' => 'integer|min:1|max:1024',
                'default'    => 1024,
            ], [
                'name'       => 'width',
                'title'      => 'admin::app.configuration.index.catalog.products.image-upload.width',
                'type'       => 'text',
                'validation' => 'integer|min:100',
                'default'    => 1000,
            ], [
                'name'       => 'height',
                'title'      => 'admin::app.configuration.index.catalog.products.image-upload.height',
                'type'       => 'text',
                'validation' => 'integer|min:100',
                'default'    => 1000,
            ],
